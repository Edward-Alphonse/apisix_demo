...
//func NewRedisStore(address, username, password string, maxIdle int, keyPairs ...[]byte) (*RediStore, error) {
...
//	})
//	return NewRedisStoreWithClient(client, keyPairs...)
...
//func NewRedisStoreWithClient(ctx context.Context, client *redis.Client, keyPairs ...[]byte) (*RediStore, error) {
//	rs := &RediStore{
...
//func (s *RediStore) New(ctx context.Context, r *http.Request, name string) (*sessions.Session, error) {
//	var (
//		err error
//		ok  bool
//	)
...
//func (s *RediStore) Delete(ctx context.Context, r *http.Request, w http.ResponseWriter, session *sessions.Session) error {
//	//conn := s.Client.Get()
//	//defer conn.Close()
...
//	//}
//	//return nil
//	err := s.Client.Del(ctx, s.keyPrefix+session.ID).Err()
//	return err
//}
